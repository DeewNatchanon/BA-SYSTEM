...
function RequestForm({ currentUser }) {
  ...
  const handleFinalSubmit = async () => {
    if (!selectedFile)
      return Swal.fire(
        "แจ้งเตือน",
        "กรุณาแนบไฟล์เอกสารก่อนกดยืนยัน",
        "warning",
      );
    ...
    try {
      ...
      Swal.fire("สำเร็จ!", "บันทึกข้อมูลและแนบไฟล์เข้าระบบสำเร็จ!", "success");
      handleCloseModal();
      localStorage.removeItem("ba-system.request-draft");
      setFormData({
        ...initialFormData,
      ...
      <form onSubmit={handleOpenCombinedModal} className="request-form">
          ...
          <section className="form-section requester-section print-keep">
            <div className="print-header">
              ...
              <div className="print-header-text">
                <div className="print-title">
                  IT Project Request Form - Requester only
                </div>
            ...
            <div className="form-row">
              <div className="form-group">
                <label>
                  Request ID: <span className="note-label">(รหัสคำขอ)</span>
                </label>
                <input
                  type="text"
                  name="requestId"
              ...
              <div className="form-group">
                <label>
                  Status: <span className="note-label">(สถานะ)</span>
                </label>
                <input
                  type="text"
                  name="status"
            ...
            <div className="form-row">
              <div className="form-group">
                <label>
                  Request Date <span className="note-label">(วันที่ขอ)</span>
                </label>
                <DatePicker
            ...
            <div className="form-row no-divider">
              <div className="form-group full-width">
                <label>
                  Name of Requester{" "}
                  <span className="note-label">(ชื่อของผู้ขอ)</span>
                </label>
                <input
                  type="text"
                  name="requesterName"
            ...
            <div className="form-row details-row">
              <div className="form-group">
                <label>
                  Dept. <span className="note-label">(แผนก)</span>
                </label>
                <input
                  type="text"
                  name="requesterDept"
              ...
              <div className="form-group">
                <label>
                  Group <span className="note-label">(กลุ่ม)</span>
                </label>
                <input
                  type="text"
                  name="requesterGroup"
                  value={formData.requesterGroup}
                  onChange={handleChange}
                />
              </div>
              <div className="form-group">
                <label>
                  Site: <span className="note-label">(ไซต์)</span>
                </label>
                <input
                  type="text"
                  name="requesterSite"
                  value={formData.requesterSite}
                  onChange={handleChange}
                />
              </div>
              <div className="form-group">
                <label>
                  Tel: <span className="note-label">(เบอร์โทรศัพท์)</span>
                </label>
                <input
                  type="text"
                  name="requesterTel"
            ...
            <div className="form-row no-divider">
              <div className="form-group full-width">
                <label>
                  Project Name <span className="note-label">(ชื่อโครงการ)</span>
                </label>
                <input
                  type="text"
                  name="projectName"
            ...
            <div className="form-row no-divider">
              <div className="form-group full-width">
                <label>
                  Project Detail:{" "}
                  <span className="note-label">(รายละเอียดของโครงการ)</span>
                </label>
                <textarea
                  name="projectDetail"
                  rows="3"
            ...
            <div className="form-row no-divider">
              <div className="form-group full-width">
                <label>
                  Requirement Detail:{" "}
                  <span className="note-label">(รายละเอียดที่ต้องการ)</span>
                </label>
                <textarea
            ...
            <div className="form-row no-divider">
              <div className="form-group full-width">
                <label>
                  Target User:{" "}
                  <span className="note-label">(กลุ่มเป้าหมายผู้ใช้ระบบ)</span>
                </label>
                <input
                  type="text"
                  name="targetUser"
            ...
            <div className="form-row no-divider">
              <div className="form-group">
                <label>
                  Use at Department:{" "}
                  <span className="note-label">(แผนกที่ใช้)</span>
                </label>
                <input
                  type="text"
                  name="useDept"
                  value={formData.useDept}
                  onChange={handleChange}
                />
              </div>
              <div className="form-group">
                <label>
                  Hospital/Company:
                  <span className="note-label">(โรงพยาบาล/บริษัท)</span>
                </label>
                <input
                  type="text"
                  name="companyName"
            ...
            <div className="form-row">
              <div className="form-group full-width">
                <label>
                  Budget Sources:{" "}
                  <span className="note-label">(แหล่งที่มาของงบประมาณ)</span>
                </label>
                <input
                  type="text"
                  name="budgetSources"
                  value={formData.budgetSources}
                  onChange={handleChange}
                />
              </div>
            </div>
              ...
              <div className="form-group full-width">
                ...
                <DatePicker
                  ...
                  onChange={(date) =>
                    setFormData((prev) => ({
                      ...prev,
                      anticipatedDate: toIsoDate(date),
                    }))
                  }
                  dateFormat="dd/MM/yyyy"
                  placeholderText="วัน/เดือน/ปี"
            ...
            <div className="form-row">
              <div className="form-group full-width">
                <label>
                  Other Remark:{" "}
                  <span className="note-label">(ข้อมูลอื่นเพิ่มเติม)</span>
                </label>
                <textarea
                  name="otherRemark"
                  rows="3"
            ...
            <div className="form-row approval-grid print-only-grid">
              <div className="approval-card">
                <div className="approval-title">
                  Requested by <span className="note-label">(ผู้ร้องขอ)</span>
                </div>
                ...
                <div className="approval-role">
                  Requester / IT Site Lead
                  <br />
                  (ผู้ขอ / หัวหน้าไซต์ IT)
                </div>
              </div>
              <div className="approval-card">
                <div className="approval-title">
                  Approved by <span className="note-label">(ผู้อนุมัติ)</span>
                </div>
                <div className="approval-sign" />
                <div className="approval-name">
                  (
                ...
                <div className="approval-date">Date :</div>
                <div className="approval-role">
                  Head of Services & Operations Grc
                  <br />
                  (Or Delegated Person)
                </div>
              </div>
            ...
            <div
              className="form-row print-hidden"
              style={{ marginTop: "20px" }}
            >
              <div className="form-group">
                <label>
                  Requester Name <span className="note-label">(ชื่อผู้ขอ)</span>
                </label>
                <input
                  type="text"
                  name="reqSign1"
                  value={formData.reqSign1}
                  onChange={handleChange}
                  placeholder="ระบุชื่อผู้ขอ"
                />
              </div>
              <div className="form-group">
                <label>
                  Head of Services Name{" "}
                  <span className="note-label">(ชื่อหัวหน้าฝ่ายบริการ)</span>
                </label>
                <input
                  type="text"
                  name="reqSign2"
                  value={formData.reqSign2}
                  onChange={handleChange}
              ...
              <div className="form-group">
                <label>
                  Head of Support Name{" "}
                  <span className="note-label">(ชื่อหัวหน้าฝ่ายสนับสนุน)</span>
                </label>
                <input
                  type="text"
                  name="reqSign3"
                  value={formData.reqSign3}
                  onChange={handleChange}
                  placeholder="ระบุชื่อผู้อนุมัติ"
                />
              </div>
            ...
            <div className="form-row print-hidden">
              <div className="form-group">
                <label>
                  ...
                  <span className="note-label">(ชื่อหัวหน้าฝ่ายการเงิน)</span>
                </label>
                <input
                  type="text"
                  name="reqSign4"
                  value={formData.reqSign4}
                  onChange={handleChange}
                  placeholder="ระบุชื่อผู้อนุมัติ"
                />
              </div>
              <div className="form-group">
                <label>
                  CIO Name{" "}
                  <span className="note-label">(ชื่อผู้อำนวยการฝ่ายไอที)</span>
                </label>
                <input
                  type="text"
                  name="reqSign5"
                  value={formData.reqSign5}
                  onChange={handleChange}
                  placeholder="ระบุชื่อผู้อนุมัติ"
                />
              </div>
        ...
        <section className="form-section gls-section print-break-before">
          <div className="print-header">
            ...
            <div className="print-header-text">
              <div className="print-title">
                IT Project Request Form - GLS IT only
              </div>
              <div className="print-subtitle">Greenline Synergy</div>
            </div>
          </div>
          ...
          <fieldset className="role-fieldset">
            <div className="form-row">
              <div className="form-group full-width">
                <label>
                  Project Category:{" "}
                  <span className="note-label">(หมวดหมู่โปรเจ็ค)</span>
                </label>
                  ...
                  {[
                    ...
                    <label key={cat} className="checkbox-item">
                      <input
                        ...
                        onChange={() =>
                          handleCheckboxChange("projectCategory", cat)
                        }
                      />
                      {cat}
                    </label>
            ...
            <div className="form-row">
              <div className="form-group full-width">
                <label>
                  Project Type:{" "}
                  <span className="note-label">(ประเภทของโปรเจ็ค)</span>
                </label>
                <div className="checkbox-group">
                  {[
                    "New System",
                    "Infrastructure",
                    "Consult (กรณีที่ IT Operation มีส่วนในการช่วยเหลือหรือให้บริการกับ Project ที่โรงพยาบาล เป็น Owner เท่านั้น)",
                  ].map((type) => (
                    <label key={type} className="checkbox-item">
                      <input
                        ...
                        onChange={() =>
                          handleCheckboxChange("projectType", type)
                        }
                      />
                      {type}
                    </label>
            ...
            <div className="form-row no-divider">
              <div className="form-group">
                <label>
                  Impact New HISB-Connect/Listed App:{" "}
                  <span className="note-label">(กระทบต่อระบบ New HIS)</span>
                </label>
              ...
              <div className="form-group">
                <label>
                  ...
                  <span className="note-label">(ชื่อระบบ/ไซต์)</span>
                </label>
                <input
                  type="text"
                  name="impactHISBApp"
            ...
            <div className="form-row">
              <div className="form-group full-width">
                <label>
                  Impact Analysis:{" "}
                  <span className="note-label">(วิเคราะห์ผลกระทบ)</span>
                </label>
                <textarea
                  name="impactAnalysis"
                  rows="3"
            ...
            <div className="form-row">
              <div className="form-group full-width">
                <label>
                  Interface with:{" "}
                  <span className="note-label">(การเชื่อมต่อกับระบบอื่น)</span>
                </label>
                <textarea
                  name="interfaceWith"
                  rows="2"
            ...
            <div className="form-row no-divider">
              <div className="form-group full-width">
                <label>
                  Resource: <span className="note-label">(ดำเนินการโดย)</span>
                </label>
                <div className="checkbox-group">
                  {[
                    "GLS ดำเนินการเอง",
                    "GLS จ้าง Vendor",
                    "โรงพยาบาลจ้าง Vendor",
                  ].map((res) => (
            ...
            <div className="form-row">
              <div className="form-group full-width">
                <label>
                  Project Manager:{" "}
                  <span className="note-label">(ผู้รับผิดชอบโครงการ)</span>
                </label>
                <input
                  type="text"
                  name="projectManager"
            ...
            <div className="form-row">
              <div className="form-group">
                <label>
                  Start Date:{" "}
                  <span className="note-label">(วันเริ่มโครงการ)</span>
                </label>
                <DatePicker
                  ...
                  onChange={(date) =>
                    setFormData((prev) => ({
                      ...prev,
                      timelineStartDate: toIsoDate(date),
                    }))
                  }
                  dateFormat="dd/MM/yyyy"
                  placeholderText="วัน/เดือน/ปี"
              ...
              <div className="form-group">
                <label>
                  End Date:{" "}
                  <span className="note-label">(วันสิ้นสุดโครงการ)</span>
                </label>
                <DatePicker
                  ...
                  onChange={(date) =>
                    setFormData((prev) => ({
                      ...prev,
                      timelineEndDate: toIsoDate(date),
                    }))
                  }
                  dateFormat="dd/MM/yyyy"
                  placeholderText="วัน/เดือน/ปี"
            ...
            <div className="form-row">
              <div className="form-group full-width">
                <label>
                  Project Cost:{" "}
                  <span className="note-label">(ต้นทุนของโปรเจ็ค)</span>
                </label>
            ...
            <div className="form-row">
              <div className="form-group">
                <label>
                  Deploy at site:{" "}
                  <span className="note-label">(ติดตั้งโปรเเกรมที่)</span>
                </label>
                <input
                  type="text"
                  name="deploySite"
                  value={formData.deploySite}
                  onChange={handleChange}
                />
              </div>
            </div>
            <div className="form-row gls-approval-grid print-only-grid">
              <div className="approval-card">
                <div className="approval-title">
                  Prepared by <span className="note-label">(ผู้จัดเตรียม)</span>
                </div>
                <div className="approval-sign" />
                <div className="approval-name">
                  (
              ...
              <div className="approval-card">
                ...
                <div className="approval-date">Date :</div>
                <div className="approval-role">
                  GLS Director, Customer Engagement Dept.
                </div>
              </div>
            </div>
            <div className="form-row print-hidden">
              <div className="form-group">
                <label>
                  Prepared by{" "}
                  <span className="note-label">(ชื่อผู้จัดเตรียม)</span>
                </label>
                <input
                  type="text"
                  name="preparedBy"
              ...
              <div className="form-group">
                <label>
                  Approved by{" "}
                  <span className="note-label">(ชื่อผู้อนุมัติ)</span>
                </label>
                <input
                  type="text"
                  name="approvedBy"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ดาวน์โหลดหรือพิมพ์เอกสารนี้
                    เพื่อนำไปให้ผู้มีอำนาจเซ็นอนุมัติตามลำดับขั้น
                  </p>
                  <button
                    type="button"
